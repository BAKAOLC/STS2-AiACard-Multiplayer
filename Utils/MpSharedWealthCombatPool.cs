...
namespace STS2_AiACard_Multiplayer.Utils
{
    internal sealed class MpSharedWealthCombatPool
    {
        ...
        private static readonly ConditionalWeakTable<ICombatState, MpSharedWealthCombatPool> Pools = new();

        public static MpSharedWealthCombatPool GetOrCreate(ICombatState combatState)
        {
