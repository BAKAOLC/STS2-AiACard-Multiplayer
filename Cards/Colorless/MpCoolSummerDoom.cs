...
namespace STS2_AiACard_Multiplayer.Cards.Colorless
{
    public sealed class MpCoolSummerDoom() : MpOnlyModCardTemplate(2, CardType.Skill, CardRarity.Rare, TargetType.Self)
    {
        ...
        public override CardAssetProfile AssetProfile =>
            new(Const.Paths.CardPortraits.MpCoolSummerDoom, Const.Paths.CardPortraits.MpCoolSummerDoom);
        ...
        protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
        {
            ...
            foreach (var c in targets)
                await PowerCmd.Apply<DoomPower>(choiceContext, c, add, Owner.Creature, this);
