...
namespace STS2_AiACard_Multiplayer.Cards.Silent
{
        ...
        : MpOnlyModCardTemplate(1, CardType.Skill, CardRarity.Uncommon, TargetType.AnyAlly)
    {
        ...
        public override CardAssetProfile AssetProfile =>
            new(Const.Paths.CardPortraits.MpNoCardsNoEnergy, Const.Paths.CardPortraits.MpNoCardsNoEnergy);

        protected override IEnumerable<IHoverTip> AdditionalHoverTips =>
            HoverTipFactory.FromCardWithCardHoverTips<Acrobatics>(IsUpgraded);
